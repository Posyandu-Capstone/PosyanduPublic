                    ...
                    <form class="form-grid" @submit.prevent="handleSubmit">
                        ...
                        <div class="section">
                            ...
                            <div class="form-row">
                                <label>VIT</label>
                                <select
                                    v-model="formData.vit"
                                    style="flex: 3"
                                    :disabled="isDisabled"
                                >
                                    <option disabled value="">Pilih VIT</option>
                                    <!-- ini jadi placeholder -->
                        ...
                        <div class="button-row">
                            ...
                            <button
                                ...
                                type="submit"
                                class="btn-submit"
                                @click="ubahPemeriksaan(anggota.nik)"
                            >
                                Ubah
                            </button>
                        </div>
...
export default {
    ...
    methods: {
        ubahPemeriksaan(nik) {
            this.$router.push({ path: `/updatepemeriksaan/${nik}` });
        },
        handleCancel() {
    ...
    mounted() {
        ...
        axios
            ...
            .then((response) => {
                console.log("Respons data pemeriksaan:", response.data); // DEBUG

                const detail = response.data?.data; // ← karena bentuk array
                ...
                if (detail) {
                    this.formData = {
                        ...
                        beritaId: detail.beritaId,
                        Diagnosa: detail.diagnosa,
                        kurun: detail.kurun, // jika ada
                        waktu: detail.waktu, // jika ada
                        ASI: detail.ASI,
                        vit: detail.vit,
                        jenis: detail.PM,
                    ...
                    console.log("Isi formData:", this.formData); // DEBUG isi field
                } else {
